...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    protected abstract T toDateTimeDataBase(LocalDateTime localDateTime);

    @Repository
    @Profile(Profiles.POSTGRES_DB)
    public static class PostgresJdbcMealRepository extends JdbcMealRepository<LocalDateTime> {
        @Override
        protected LocalDateTime toDateTimeDataBase(LocalDateTime localDateTime) {
    ...
    public static class HsqlJdbcMealRepository extends JdbcMealRepository<Timestamp> {
        @Override
        protected Timestamp toDateTimeDataBase(LocalDateTime localDateTime) {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", toDateTimeDataBase(meal.getDateTime()))
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, toDateTimeDataBase(startDateTime), toDateTimeDataBase(endDateTime));
    }
}
