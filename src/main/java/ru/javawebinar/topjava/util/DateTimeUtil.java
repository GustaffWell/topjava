...
public class DateTimeUtil {
    ...
    public static <T extends Comparable<T>> boolean isBetweenHalfOpen(T currentValue, T start, T end) {
        return currentValue.compareTo(start) >= 0 && currentValue.compareTo(end) < 0;
    }
