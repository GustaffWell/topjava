...
public class MealTestData {
    ...
    public static final Meal userMeal7 = new Meal(USER_MEAL_1_ID + 6,
            ...
            "Ужин", 410);
    public static final Meal userMeal8 = new Meal(USER_MEAL_1_ID + 7,
            LocalDateTime.of(2023, Month.JANUARY, 31, 20, 0),
            "Ужин", 410);

    public static Meal getNew() {
        return new Meal(LocalDateTime.of(2019, Month.JANUARY, 31, 20, 0),
                "new meal", 500);
    }

    public static Meal getUpdated() {
        Meal updated = new Meal(userMeal1);
        updated.setDateTime(updated.getDateTime().plusMinutes(1));
