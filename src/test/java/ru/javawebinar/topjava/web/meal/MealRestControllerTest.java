...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void invalidCreate() throws Exception {
        Meal invalid = new Meal(null, null, null, 1);
    ...
    void duplicateUpdate() throws Exception {
        Meal invalid = new Meal(MEAL1_ID, meal2.getDateTime(), "test", 200);
    ...
    void duplicateCreate() throws Exception {
        Meal invalid = new Meal(null, adminMeal1.getDateTime(), "test", 200);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalid))
                .with(userHttpBasic(admin)))
